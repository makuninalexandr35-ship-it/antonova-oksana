...
function antonova_default_flavors() {
    return array(
        array('name' => "Медовик\nклассический", 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/cd528ac478c6-1122.webp')),
        array('name' => 'Медовик авторский', 'subtitle' => 'Красный бархат, апельсиновый, тархун-алоэ', 'image' => antonova_theme_asset('assets/optimized/0196b7589d20-1122.webp')),
        array('name' => 'Наполеон', 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/e79c5604082f-1122.webp')),
        array('name' => "Шоколадный\nс вишнёвым конфи", 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/dd43c1d61dc7-1122.webp')),
        array('name' => "Шпинатный\nс лимонным курдом", 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/54fccadc43c4-1122.webp')),
        array('name' => 'Рафаэлло', 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/473c6a3b3d19-1122.webp')),
        array('name' => 'Марс', 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/0b67946f94f7-1122.webp')),
        array('name' => 'Ваниль — клубника', 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/a298af3bbaf0-1122.webp')),
        array('name' => "Шоколадный\nс дубайской начинкой", 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/4c3df46db0ec-1122.webp')),
        array('name' => 'Груша — дорблю', 'subtitle' => '', 'image' => antonova_theme_asset('assets/optimized/7521e197859c-1122.webp')),
    );
}
